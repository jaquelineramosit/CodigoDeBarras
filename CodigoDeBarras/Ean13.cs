...
namespace CodigoDeBarras
{
    public class Ean13
    {
        ...
        public void CalculateChecksumDigit()
        {
           ...
           // string sTemp = this.CountryCode.Substring(1,1) + this.ManufacturerCode + this.ProductCode + this.ChecksumDigit;
        ...
        public void ImprimirEtiquetaCompleta(System.Drawing.Graphics g, EstoqueImpressaoEtiqueta estoqueImpressaoEtiqueta, int xInicio, float yInicio, System.Drawing.Point pt)
        {
            ...
            g.DrawString(sTemp.Substring(0, 1), font, brush, new System.Drawing.PointF(xPosition, yPosition)); //yPosition - 2

            xPosition += (g.MeasureString(sTemp.Substring(0, 1), font).Width + 43 * lineWidth) -
                (g.MeasureString(sTemp.Substring(1, 6), font).Width);

            // Draw MFG Number.
            g.DrawString(sTemp.Substring(1, 6), font, brush, new System.Drawing.PointF(xPosition, yPosition)); //yPosition - 2

            xPosition += g.MeasureString(sTemp.Substring(1, 6), font).Width + (11 * lineWidth);

            // Draw Product ID.
            g.DrawString(sTemp.Substring(7), font, brush, new System.Drawing.PointF(xPosition, yPosition)); //yPosition - 2
